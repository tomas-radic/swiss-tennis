...
describe CreateRound do
  ...
  let!(:ranking1p) { create(:ranking, :relevant, round: round1p, player: player1, points: 1, sets_difference: 1, games_difference: 1) }
  let!(:ranking2p) { create(:ranking, :relevant, round: round1p, player: player2, points: 2, sets_difference: 2, games_difference: 2) }

  # Current season rankings
  let!(:ranking1c1) { create(:ranking, :relevant, round: round1c, player: player1, points: 3, sets_difference: 1, games_difference: 3) }
  let!(:ranking1c2) { create(:ranking, :relevant, round: round1c, player: player2, points: 4, sets_difference: 3, games_difference: 3) }
  let!(:ranking2c1) { create(:ranking, :relevant, round: round2c, player: player1, points: 5, sets_difference: 2, games_difference: 5) }
  let!(:ranking2c2) { create(:ranking, :relevant, round: round2c, player: player2, points: 6, sets_difference: 4, games_difference: 6) }
