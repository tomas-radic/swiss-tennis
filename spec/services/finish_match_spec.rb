...
describe FinishMatch do
  ...
  let!(:ranking11) { create(:ranking, round: round1, player: player1, points: 0, handicap: 1, sets_difference: 1, games_difference: 4) }
  let!(:ranking12) { create(:ranking, round: round1, player: player2, points: 2, handicap: 0, sets_difference: -1, games_difference: 2) }
  let!(:ranking21) { create(:ranking, round: round2, player: player1, points: 0, handicap: 1, sets_difference: 3, games_difference: 4) }
  let!(:ranking22) { create(:ranking, round: round2, player: player2, points: 2, handicap: 0, sets_difference: -2, games_difference: 2) }
  let!(:ranking_r1_of_p1_opponent_from_r1) { create(:ranking, round: round1, player: opponent_r1_p1, points: 1, handicap: 2, sets_difference: 1, games_difference: 5, relevant: true) }
  let!(:ranking_r2_of_p1_opponent_from_r1) { create(:ranking, round: round2, player: opponent_r1_p1, points: 1, handicap: 2, sets_difference: 1, games_difference: 5, relevant: true) }
  let!(:ranking_r1_of_p2_opponent_from_r1) { create(:ranking, round: round1, player: opponent_r1_p2, points: 0, handicap: 1, sets_difference: 1, games_difference: 5, relevant: false) }
  let!(:ranking_r2_of_p2_opponent_from_r1) { create(:ranking, round: round2, player: opponent_r1_p2, points: 0, handicap: 1, sets_difference: 1, games_difference: 5, relevant: false) }
    ...
    context 'With 3 sets match' do
      ...
      it 'Updates rankings of current round for both players and previous opponents' do
        ...
        expect(ranking21.reload).to have_attributes(
            points: 1, handicap: 3, sets_difference: 4, games_difference: 7, relevant: true)
        expect(ranking22.reload).to have_attributes(
            points: 2, handicap: 1, sets_difference: -3, games_difference: -1, relevant: true)
        expect(ranking_r2_of_p1_opponent_from_r1.reload).to have_attributes(
            points: 1, handicap: 3, sets_difference: 1, games_difference: 5, relevant: true)
      end
      ...
      it 'Does not update other rankings' do
        ...
        expect(ranking11.reload).to have_attributes(
          points: 0, handicap: 1, sets_difference: 1, games_difference: 4, relevant: false
        )
        expect(ranking12.reload).to have_attributes(
          points: 2, handicap: 0, sets_difference: -1, games_difference: 2, relevant: false
        )
        expect(ranking_r1_of_p1_opponent_from_r1.reload).to have_attributes(
          points: 1, handicap: 2, sets_difference: 1, games_difference: 5, relevant: true
        )
        expect(ranking_r1_of_p2_opponent_from_r1.reload).to have_attributes(
          points: 0, handicap: 1, sets_difference: 1, games_difference: 5, relevant: false
        )
    ...
    context 'With 2 sets match' do
      context 'And correct score' do
        ...
        it 'Updates rankings of current round for both players and previous opponents' do
          ...
          expect(ranking21.reload).to have_attributes(
              points: 0, handicap: 4, sets_difference: 1, games_difference: -5, relevant: true)
          expect(ranking22.reload).to have_attributes(
              points: 3, handicap: 0, sets_difference: 0, games_difference: 11, relevant: true)
          expect(ranking_r2_of_p2_opponent_from_r1.reload).to have_attributes(
              points: 0, handicap: 2, sets_difference: 1, games_difference: 5, relevant: false)
        end
      ...
      context 'And incorrect score' do
        ...
        it 'Does not update rankings of players' do
          ...
          expect(ranking11.reload).to have_attributes(
            points: 0, handicap: 1, sets_difference: 1, games_difference: 4)
          expect(ranking12).to have_attributes(
            points: 2, handicap: 0, sets_difference: -1, games_difference: 2)
          expect(ranking21).to have_attributes(
            points: 0, handicap: 1, sets_difference: 3, games_difference: 4)
          expect(ranking22).to have_attributes(
            points: 2, handicap: 0, sets_difference: -2, games_difference: 2)
    ...
    context 'With 1 set match' do
      context 'And correct score' do
        ...
        it 'Updates rankings of current round for both players and previous opponents' do
          ...
          expect(ranking21.reload).to have_attributes(
              points: 0, handicap: 4, sets_difference: 2, games_difference: 3, relevant: true)
          expect(ranking22.reload).to have_attributes(
              points: 3, handicap: 0, sets_difference: -1, games_difference: 3, relevant: true)
          expect(ranking_r2_of_p2_opponent_from_r1.reload).to have_attributes(
              points: 0, handicap: 2, sets_difference: 1, games_difference: 5, relevant: false)
        end
      ...
      context 'Special case when there is next round with rankings already existing' do
        ...
        let!(:ranking_r3_of_p2_opponent_from_r1) { create(:ranking, round: round3, player: opponent_r1_p2, points: ranking_r2_of_p2_opponent_from_r1.points, handicap: ranking_r2_of_p2_opponent_from_r1.handicap, sets_difference: ranking_r2_of_p2_opponent_from_r1.sets_difference, games_difference: ranking_r2_of_p2_opponent_from_r1.games_difference, relevant: ranking_r2_of_p2_opponent_from_r1.relevant) }
  ...
  context 'With retirement during the match' do
    ...
    it 'Updates rankings including handicap of the player retired' do
      ...
      expect(ranking21.reload).to have_attributes(
          points: 0, handicap: 4, sets_difference: 2, games_difference: 9, relevant: true)
      expect(ranking22.reload).to have_attributes(
          points: 3, handicap: 0, sets_difference: -1, games_difference: -3, relevant: true)
      expect(ranking31.reload).to have_attributes(
          points: 0, handicap: 4, sets_difference: 2, games_difference: 9, relevant: true)
  ...
  context 'With retirement with no games played' do
    ...
    it 'Updates rankings of players and winner opponents' do
      ...
      expect(ranking21.reload).to have_attributes(
          points: 2, handicap: 3, sets_difference: 5, games_difference: 4, relevant: true)
      expect(ranking22.reload).to have_attributes(
          points: 2, handicap: 3, sets_difference: -4, games_difference: 2, relevant: false)
      expect(ranking31.reload).to have_attributes(
          points: 2, handicap: 3, sets_difference: 5, games_difference: 4, relevant: true)
      expect(ranking32.reload).to have_attributes(
          points: 2, handicap: 3, sets_difference: -4, games_difference: 2, relevant: false)
